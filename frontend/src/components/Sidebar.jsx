...
import OtherUsers from './OthersUser';
...
const Sidebar = () => {
    ...
    const searchSubmitHandler = (e) => {
        e.preventDefault();
        const conversationUser = findMatchingUser(search);
        if (conversationUser) {
        ...
        <div className='border-r border-slate-500 p-4 flex flex-col'>
            <form onSubmit={searchSubmitHandler} action="" className='flex items-center gap-2'>
                <input
                    ...
                    className='input input-bordered rounded-md flex-1' type="text"
                    placeholder='Search...'
                />
